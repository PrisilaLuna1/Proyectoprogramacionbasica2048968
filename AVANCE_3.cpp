...
struct articulos
{
	...
	string descripcion, status, genero, gener,clasificacion, consola, consol;
...
void Alta()
{
	...
	for (int i = 0; i < nalta; i++)
	{
		...
		do {
			...
			if (gen == 7) { menu[i].genero = "Otro"; printf("Especificac%cn del g%cnero\n", 162, 130); getline(cin, menu[i].gener);}
			printf("----------------------------------\n");
		...
		do {
			...
			if (con == 5) { menu[i].consola = "Otro"; printf("Especificaci%cn de la consola\n", 162); getline(cin, menu[i].consol); }
			printf("----------------------------------\n");
			if (clas < 1 || 5 < clas) { SetConsoleTextAttribute(Conh, 244); printf("Opcion no valida\n"); SetConsoleTextAttribute(Conh, 241); }
		} while (con < 1 || 5 < con);
		//fin de consola
...
{
	int opc4, opc5, b = 0;
	printf("%cQu%c desea realizar?\n1. Ver lista de items completa\n2. Ver Men%c de b%csqueda\n", 168, 130, 163, 163);
	scanf_s("%d", &opc4);
	switch (opc4)
	{
	case 1:
		for (int i = 0; i < nalta; i++)
		{
			...
			else
			{
				...
				if (menu[i].genero == "Otro")
				{
					printf("G%cnero: %s \n", 130, menu[i].gener.c_str());
				}
				else
				{
	...
	case 2:
		printf("----------------------------------\n");
		printf("\t Men%c de b%csqueda \n", 163, 163);
		printf("----------------------------------\n");
		printf("1. Por g%cnero\n", 130);
		printf("2. Por clasificaci%cn\n", 162);
		printf("3. Por consola\n");
		scanf_s("%d", &opc5);
		switch (opc5)
		{
		case 1:
		...
		case 2:
			...
			case 1:
				for (int i = 0; i <= nalta; i++) {
					if (menu[i].genero == "Todas las edades")
					{
						printf(" Registro n%cmero %d\n", 163, i + 1);
						printf("N%cmero de item: %d \n", 163, menu[i].item);
						printf("Nombre del art%cculo: %s \n", 161, menu[i].nombre);
			...
			case 5:
				for (int i = 0; i <= nalta; i++) {
					if (menu[i].genero == "Solo adultos (+18)")
					{
						printf(" Registro n%cmero %d\n", 163, i + 1);
						printf("N%cmero de item: %d \n", 163, menu[i].item);
						printf("Nombre del art%cculo: %s \n", 161, menu[i].nombre);
